#!/usr/bin/env python3
"""
Run every runnable code sample and exercise solution in json/week1.json and compare the
...
def main():
    ...
    week = json.loads((ROOT / "json" / "week1.json").read_text())
